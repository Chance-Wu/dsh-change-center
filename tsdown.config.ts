/**
 * tsdown config for dsh-change-center.
 *
 ...
 * same `__ModuleLoader__.load({id, factory})` closure shape the Harness web
 ...
 * a `<style data-plugin="dsh-change-center">` tag at factory execution (the
 * loader removes plugin-owned tags on unload). This mirrors the Harness
 * client-bundle pipeline.
 */
...
const CLIENT_ID = 'dsh-change-center'
